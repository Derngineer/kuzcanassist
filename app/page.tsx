...
export default function Home() {
  ...
  const whatsappMessage = encodeURIComponent("Hello! I would like to enquire about your luxury personal shopping and concierge services. Please let me know how I can get started.");
    ...
    <main className="min-h-screen bg-[#050505] text-[#f5f5f5]">
      ...
      >
        ...
        >
          <div className="px-6 py-8 flex flex-col gap-6">
            ...
            <a href="https://lyannes.com/" target="_blank" rel="noopener noreferrer" className="text-lg tracking-widest uppercase text-[#c9a962] hover:text-[#f5f5f5]">Lyannes ↗</a>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          >
            <source src="/backgroundvid.webm" type="video/webm" />
          </video>
      ...
      {/* City View Section - Full-width cinematic showcase */}
      <section id="cityview" className="relative h-[70vh] min-h-[500px] overflow-hidden">
        ...
        <video
          ...
          className="absolute inset-0 w-full h-full object-cover"
        >
          <source src="/cityview.webm" type="video/webm" />
        </video>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <p className="text-[#c9a962] text-sm tracking-[0.4em] uppercase mb-4 font-[family-name:var(--font-montserrat)] animate-fade-in">
            The Heart of Luxury
          </p>
          <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-6xl lg:text-7xl font-medium mb-6 animate-fade-in-up">
            <span className="text-[#f5f5f5]">Dubai</span>
            <span className="block gradient-text">Awaits You</span>
          </h2>
          <p className="text-[#f5f5f5]/70 font-[family-name:var(--font-cormorant)] text-xl md:text-2xl max-w-2xl leading-relaxed mb-8">
            Where golden sunsets meet architectural marvels, and every street tells a story of ambition and elegance.
          </p>
          <a href="#contact" className="btn-luxury">
            Start Your Journey
          </a>
        ...
        {/* Decorative corners */}
        <div className="absolute top-8 left-8 w-24 h-24 border-l border-t border-[#c9a962]/30" />
        <div className="absolute bottom-8 right-8 w-24 h-24 border-r border-b border-[#c9a962]/30" />
      </section>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center">
              ...
              <a href="https://wa.me/971557867183" target="_blank" rel="noopener noreferrer" className="text-[#f5f5f5]/70 hover:text-[#c9a962] transition-colors">+971 55 786 7183</a>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 mx-auto border border-[#c9a962]/50 rounded-full flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-[#c9a962]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-4 mb-6">
                <a href="https://www.instagram.com/kuzie_can_assist/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-[#c9a962]/30 flex items-center justify-center hover:bg-[#c9a962] hover:border-[#c9a962] group transition-colors">
                  <svg className="w-5 h-5 text-[#c9a962] group-hover:text-[#050505]" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                  </svg>
                </a>
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-[#c9a962]/30 flex items-center justify-center hover:bg-[#25D366] hover:border-[#25D366] group transition-colors">
                  <svg className="w-5 h-5 text-[#c9a962] group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981zm11.387-5.464c-.074-.124-.272-.198-.57-.347-.297-.149-1.758-.868-2.031-.967-.272-.099-.47-.149-.669.149-.198.297-.768.967-.941 1.165-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.521.151-.172.2-.296.3-.495.099-.198.05-.372-.025-.521-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.501-.669-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306 1.263.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.695.248-1.29.173-1.414z"/>
                  </svg>
                </a>
                <a href={`tel:${callNumber}`} className="w-10 h-10 border border-[#c9a962]/30 flex items-center justify-center hover:bg-[#c9a962] hover:border-[#c9a962] group transition-colors">
                  <svg className="w-5 h-5 text-[#c9a962] group-hover:text-[#050505]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </a>
              </div>
              <div>
                <p className="text-[#f5f5f5]/50 text-xs uppercase tracking-wider mb-2">Sister Brand</p>
                <a href="https://lyannes.com/" target="_blank" rel="noopener noreferrer" className="text-[#c9a962] hover:text-[#d4b87a] transition-colors font-[family-name:var(--font-playfair)]">
                  Lyannes — Skincare & Body Care
                </a>
              </div>
            </div>
          </div>
