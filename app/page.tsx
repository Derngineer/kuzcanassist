      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <a href="#" className="flex flex-col items-center">
            ...
            />
            <span className="text-[10px] tracking-[0.2em] uppercase text-[#f5f5f5] mt-1 font-[family-name:var(--font-montserrat)]">Kuzie Can Assist</span>
          </a>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-4 mb-6">
                ...
                <a href="https://wa.me/971557867183" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-[#c9a962]/30 flex items-center justify-center hover:bg-[#c9a962] hover:border-[#c9a962] group transition-colors">
                  <svg className="w-5 h-5 text-[#c9a962] group-hover:text-[#050505]" fill="currentColor" viewBox="0 0 24 24">
